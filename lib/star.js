...
module.exports = {
  ...
  printQR: function (str, settings) {
    if (settings) {
      throw new Error('QR settings not yet available for star printers!');
    }
  ...
  printImageStar: function (image) {
    return new Promise((resolve, reject) => {
      ...
      pipe.on('parsed', function () {
        let buff = module.exports._printImageBufferStar(this.width, this.height, this.data);
        resolve(buff);
      });
  ...
  _printImageBufferStar: function (width, height, data) {
