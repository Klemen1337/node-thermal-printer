module.exports = {
    ...
    CHARCODES: {
      ...
      PC437      : Buffer.from([0x1b, 0x74, 0]), // PC437: USA, Standard Europe
      Katakana   : Buffer.from([0x1b, 0x74, 1]), // Katakana
      PC850      : Buffer.from([0x1b, 0x74, 2]), // PC850: Multilingual
      PC860      : Buffer.from([0x1b, 0x74, 3]), // PC860: Portuguese
      PC863      : Buffer.from([0x1b, 0x74, 4]), // PC863: Canadian-French
      PC865      : Buffer.from([0x1b, 0x74, 5]), // PC865: Nordic
      ...
      PC851      : Buffer.from([0x1b, 0x74, 11]), // PC851: Greek
      PC853      : Buffer.from([0x1b, 0x74, 12]), // PC853: Turkish
      PC857      : Buffer.from([0x1b, 0x74, 13]), // PC857: Turkish
      PC737      : Buffer.from([0x1b, 0x74, 14]), // PC737: Greek
      ISO8859_7  : Buffer.from([0x1b, 0x74, 15]), // ISO8859-7: Greek
      WPC1252    : Buffer.from([0x1b, 0x74, 16]), // WPC1252 Russian
      PC866      : Buffer.from([0x1b, 0x74, 17]), // PC866: Cyrillic #2
      PC852      : Buffer.from([0x1b, 0x74, 18]), // PC852: Latin 2
      PC858      : Buffer.from([0x1b, 0x74, 19]), // PC858: Euro
      ...
      PC720      : Buffer.from([0x1b, 0x74, 32]), // PC720: Arabic
      WPC775     : Buffer.from([0x1b, 0x74, 33]), // WPC775: Baltic Rim
      PC855      : Buffer.from([0x1b, 0x74, 34]), // PC855: Cyrillic
      PC861      : Buffer.from([0x1b, 0x74, 35]), // PC861: Icelandic
      PC862      : Buffer.from([0x1b, 0x74, 36]), // PC862: Hebrew
      PC864      : Buffer.from([0x1b, 0x74, 37]), // PC864: Arabic
      PC869      : Buffer.from([0x1b, 0x74, 38]), // PC869: Greek
      ISO8859_2  : Buffer.from([0x1b, 0x74, 39]), // ISO8859-2: Latin 2
      ISO8859_15 : Buffer.from([0x1b, 0x74, 40]), // ISO8859-15: Latin 9
      PC1098     : Buffer.from([0x1b, 0x74, 41]), // PC1098: Farsi
      PC1118     : Buffer.from([0x1b, 0x74, 42]), // PC1118: Lithuanian
      PC1119     : Buffer.from([0x1b, 0x74, 43]), // PC1119: Lithuanian
      PC1125     : Buffer.from([0x1b, 0x74, 44]), // PC1125: Ukrainian
      WPC1250    : Buffer.from([0x1b, 0x74, 45]), // WPC1250: Latin 2
      WPC1251    : Buffer.from([0x1b, 0x74, 46]), // WPC1251: Cyrillic
      WPC1253    : Buffer.from([0x1b, 0x74, 47]), // WPC1253: Greek
      WPC1254    : Buffer.from([0x1b, 0x74, 48]), // WPC1254: Turkish
      WPC1255    : Buffer.from([0x1b, 0x74, 49]), // WPC1255: Hebrew
      WPC1256    : Buffer.from([0x1b, 0x74, 50]), // WPC1256: Arabic
      WPC1257    : Buffer.from([0x1b, 0x74, 51]), // WPC1257: Baltic Rim
      WPC1258    : Buffer.from([0x1b, 0x74, 52]), // WPC1258: Vietnamese
      KZ1048	   : Buffer.from([0x1b, 0x74, 53]), // KZ-1048: Kazakhstan
