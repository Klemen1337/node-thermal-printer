...
PAPER_PART_CUT : BBuffer.from([0x1b, 0x69, 0x43,0x02]), // Cancels cutting
...
// Character code pages / iconv name of code table.
  ...
  CODE_PAGES: {
    CODE_PAGE_STANDARD             : 'CP437',
    CODE_PAGE_WESTERN_EUROPEAN     : 'CP1252',
    CODE_PAGE_EASTERN_EUROPEAN     : 'WIN1250',
    CODE_PAGE_JAPANESE             : 'EUC-JP',
