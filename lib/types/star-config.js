module.exports = {
    ...
    // Char code table
    CHARCODE_PC437  : Buffer.from([0x1b, 0x1d, 0x74, 0x00]), // USA: Standard Europe
    CHARCODE_JIS    : Buffer.from([0x1b, 0x1d, 0x74, 0x02]), // Japanese Katakana
    CHARCODE_PC858  : Buffer.from([0x1b, 0x1d, 0x74, 0x04]), // Multilingual
    CHARCODE_PC860  : Buffer.from([0x1b, 0x1d, 0x74, 0x06]), // Portuguese
    CHARCODE_PC863  : Buffer.from([0x1b, 0x1d, 0x74, 0x08]), // Canadian-French
    CHARCODE_PC865  : Buffer.from([0x1b, 0x1d, 0x74, 0x09]), // Nordic
    CHARCODE_GREEK  : Buffer.from([0x1b, 0x1d, 0x74, 0x0f]), // Greek
    CHARCODE_HEBREW : Buffer.from([0x1b, 0x1d, 0x74, 0x0d]), // Hebrew
    CHARCODE_PC1252 : Buffer.from([0x1b, 0x1d, 0x74, 0x20]), // Western European Windows Code Set
    CHARCODE_PC866  : Buffer.from([0x1b, 0x1d, 0x74, 0x0a]), // Cirillic //2
    CHARCODE_PC852  : Buffer.from([0x1b, 0x1d, 0x74, 0x05]), // Latin 2
    CHARCODE_THAI42 : Buffer.from([0x1b, 0x1d, 0x74, 0x60]), // Thai character code 42
    CHARCODE_THAI11 : Buffer.from([0x1b, 0x1d, 0x74, 0x61]), // Thai character code 11
    CHARCODE_THAI13 : Buffer.from([0x1b, 0x1d, 0x74, 0x62]), // Thai character code 13
    CHARCODE_THAI14 : Buffer.from([0x1b, 0x1d, 0x74, 0x63]), // Thai character code 14
    CHARCODE_THAI16 : Buffer.from([0x1b, 0x1d, 0x74, 0x64]), // Thai character code 16
    CHARCODE_THAI17 : Buffer.from([0x1b, 0x1d, 0x74, 0x65]), // Thai character code 17
    CHARCODE_THAI18 : Buffer.from([0x1b, 0x1d, 0x74, 0x66]), // Thai character code 18
