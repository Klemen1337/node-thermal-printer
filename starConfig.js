module.exports = {
    ...
    CTL_SET_VT : '\x1b\x42',          // Set vertical tab positions
    ...
    PAPER_PART_CUT  : '\x1b\x64\x03', // Partial cut paper

    // Text format
    TXT_NORMAL      : '\x1b\x69\x00\x00', // Normal text
    TXT_2HEIGHT     : '\x1b\x69\x01\x00', // Double height text
    TXT_2WIDTH      : '\x1b\x69\x00\x01', // Double width text
    TXT_4SQUARE     : '\x1b\x69\x01\x01', // Quad area text
    ...
    TXT_ALIGN_CT    : '\x1b\x1d\x61\x01', // Centering
    TXT_ALIGN_RT    : '\x1b\x1d\x61\x02', // Right justification
